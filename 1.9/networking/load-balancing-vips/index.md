...
4. You must use a supported [operating system](/docs/1.9/installing/custom/system-requirements/).
...
- [Assign a VIP to your application](/docs/1.9/service-discovery/load-balancing-vips/virtual-ip-addresses/)
