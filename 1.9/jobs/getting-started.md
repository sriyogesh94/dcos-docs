...
**Note:** The DC/OS web interface provides a subset of the CLI and API functionality. For advanced job configurations, use the [dcos job](/docs/1.9/administering-clusters/cli/command-reference/dcos-job/) commands or the Jobs [API](#jobs-api).
