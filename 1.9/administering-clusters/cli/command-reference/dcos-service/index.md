...
| Command | Description |
|---------|-------------|
| [dcos service log](/docs/1.9/administering-clusters/cli/command-reference/dcos-service/dcos-service-log/)   | Print the service logs. | 
| [dcos service shutdown](/docs/1.9/administering-clusters/cli/command-reference/dcos-service/dcos-service-shutdown/)   | Shutdown a service. |