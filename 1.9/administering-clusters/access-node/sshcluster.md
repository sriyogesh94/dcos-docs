...
2.  SSH into the cluster.
    ...
    *   **To SSH to an agent node:**
        ...
        1.  From the DC/OS CLI, enter the following command, where `<mesos-id>` is your agent ID. 
            ...
            **Tip:** To find the agent ID, select the **Nodes** tab in the DC/OS [web interface](/docs/1.9/administering-clusters/webinterface/) and click **Details**. 
...
2.  SSH into the cluster.
 ...
 [1]: /docs/1.9/administering-clusters/cli/command-reference/
 [2]: #unix
 [3]: #windows
