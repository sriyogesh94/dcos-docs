...
If you run HAProxy in front of Admin Router, you should secure the communication between them. For information about securing your communication, see the [documentation](/docs/1.9/id-and-access-mgt/tls-ssl/haproxy-adminrouter/).
...
[Marathon-LB](/docs/1.9/service-discovery/marathon-lb/) with HTTPS for
...
See the [Security Administrator's Guide](/docs/1.9/id-and-access-mgt/) for more information.
