...
1.  [SSH to the agent node](/docs/1.9/administering-clusters/access-node/sshcluster/) that is running your app, where (`--mesos-id=<mesos-id>`) is the Mesos ID of the node running your app.
