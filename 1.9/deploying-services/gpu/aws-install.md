...
1. Follow the instructions [here](/docs/1.9/installing/cloud/aws/advanced/) to create a cluster with advanced AWS templates, but use the following GPU-specific configuration.
