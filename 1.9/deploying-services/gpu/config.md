...
**Important:** You must use the [DC/OS Universal Container Runtime](/docs/1.9/deploying-services/containerizers/) to run a containerized application that uses GPUs. To use the Universal Container Runtime, set the container type to `MESOS`.
```
{
    "id": "docker-gpu-test",
    "acceptedResourceRoles":["slave_public", "*"],
...
See [here for limitations and further information](/docs/1.9/deploying-services/gpu/limitations/).
