...
Once your cluster is [configured to support GPUs](/docs/1.9/administration/gpu/), add the `gpus` parameter to your [Marathon application definition](/docs/1.9/usage/managing-services/creating-services/).
