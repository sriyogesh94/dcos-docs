...
To run Docker containers with the Universal container runtime, specify the container type `MESOS` and a `docker` object in your [Marathon application definition](/docs/1.9/usage/managing-services/creating-services/).
...
* [Follow a Docker app tutorial](/docs/1.9/usage/managing-services/creating-services/deploy-docker-app/).
