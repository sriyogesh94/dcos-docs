...
| `networks`              | array        |  Takes the following parameters: `mode`, `name`, and `labels`.                                                                                                                                                                                                                 |
...
| `scaling`               | array        |  Takes the following parameters: `kind`, `instances`, and `maxInstances`.                                                                                                                                                                                                                 |
...
| `containers.exec`                   | object  |  Takes the `command` parameter.                                                                                                          |
...
| `containers.volumeMounts`           | array   |  Takes the following parameters: `name` and `mountPath`.                                                                                                          |
...
| `healthCheck`                  |  object       |  Takes the following parameters: `http`, `tcp`, and `exec`.                                                                                                                       |
