...
1.  From the DC/OS [web interface](/docs/1.10/gui/), click on the **Services** tab and either click your service name or click **RUN A SERVICE** to create a new service.
